...
//  14StringsTestHW01
//
//  Created by Pronin Alexander on 11.02.14.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSInteger halfLength = [text length] / 2;
    
    NSRange     range01     = NSMakeRange(0, halfLength);
    NSRange     range02     = NSMakeRange(halfLength, [text length] - halfLength);
    
    NSString*   string01    = [text substringWithRange:range01];
    NSString*   string02    = [text substringWithRange:range02];
...
// #warning calculate range02

// TODO: Fix calculation range02
// !!!: Waining - fix calculation range02
